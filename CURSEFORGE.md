...
Requires MMO Skill Tree 1.6.1 or newer and Ziggfreed's CommonLib 2.1.0 or newer. The pack supplies the content; the board and shop engines ship with the mod and its library, so install all three.
...
1. Install MMO Skill Tree (1.6.1 or newer) and Ziggfreed's CommonLib (2.1.0 or newer), which it loads first.
